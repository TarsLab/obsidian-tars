...
- [ ] Add toggle button for each server config
- [ ] Display URL→command conversion (npx -y mcp-remote <url>)
- [ ] Keep simple and advanced views in sync
- [ ] Persist user's view preference
- [ ] Add live conversion preview
