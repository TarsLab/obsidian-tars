...
- **Total Remaining Story Points**: 82 SP (74 SP from original + 8 SP from Epic-1000)
- **Epics In Scope**: Epic-1000 (stabilization), Epic-500, Epic-600, Epic-700 (validation only), Epic-900
...
- [x] **Task-900-10-5-4: Add tests for document-scoped sessions** ✅
  - **Files**: `tests/mcp/executor.test.ts`
...
- [x] **Task-900-30-5-2: Implement collapsible MCP Servers section** ✅
  - **Files**: `src/settingTab.ts`
...
- **Epic-900 (P1, 31 SP)**: Continue with remaining document-scoped sessions and UX enhancements
